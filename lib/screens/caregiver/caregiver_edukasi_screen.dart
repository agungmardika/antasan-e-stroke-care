...
class CaregiverEdukasiScreen extends StatelessWidget {
  const CaregiverEdukasiScreen({super.key});
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          currentIndex: 2, // Edukasi
          elevation: 0,
          onTap: (index) {
            if (index == 0) {
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const CaregiverDashboardScreen()), (route) => false);
            } else if (index == 1) {
